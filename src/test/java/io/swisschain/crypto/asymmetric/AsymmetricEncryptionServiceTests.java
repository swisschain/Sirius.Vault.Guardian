...
public class AsymmetricEncryptionServiceTests {
  ...
  @Test
  public void decrypt_secret() throws IOException, InvalidCipherTextException {
    // arrange

    var expectedSecret = "jSLbiNEpt0sDuXQZPiFZWCcCpcUpm5GC2eCi1uUO+Xg=";
    ...
    var encryptedData =
            "r1yHhIEjMZXvaBaUi4XeD58N6MBy2K6qRtEkH49K7ijqREZ9AIG9q7YGzfBrrNMK4KBwLxT26yMV8CYPvUzyNY\u002BH3sG5XDWsypHD7dSz34NT7fwmWaZHfDtf1//qH4lyFPG87teShHIAswQCdiJ76rjMYnYdbf0tkAHR371yIpg=";

    // act

    var decryptedDate = service.decrypt(Base64.getDecoder().decode(encryptedData), privateKey);

    var actualSecret = Base64.getEncoder().encodeToString(decryptedDate);
